...
CONTACT_PARAGRAPH_STYLE = ParagraphStyle('contact_paragraph', fontName = GARAMOND_REGULAR, fontSize=12, allowWidows=0, allowOrphans=0, alignment = TA_CENTER)
...
COMPANY_DURATION_PARAGRAPH_STYLE = ParagraphStyle('company_duration_paragraph', fontName = GARAMOND_REGULAR, fontSize=11, alignment = TA_RIGHT)
